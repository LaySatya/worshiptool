  ...
  return (
    <div className="space-y-6 text-sm">
      ...
      <Section title="Colors">
        ...
        />
        <ColorPicker
          label="Verse Number Color"
          value={settings.verse_num_color}
          onChange={v => set('verse_num_color', v)}
        />
        <ColorPicker
      ...
      <Section title="Reference">
        <SliderField
          label="Ref / Verse # Size"
          value={settings.ref_font_size}
          onChange={v => set('ref_font_size', v)}
          min={8} max={48} step={1} unit=" pt"
        />
        <Toggle
          label="Show reference on every slide"
          checked={settings.show_ref_each}
          onChange={v => set('show_ref_each', v)}
        />
      </Section>
